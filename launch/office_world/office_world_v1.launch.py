...
def generate_launch_description():
  ...
  declare_map_yaml_cmd = DeclareLaunchArgument(
    ...
    description='/home/don/cafe/src/two_wheeled_robot/maps')
        
  declare_params_file_cmd = DeclareLaunchArgument(
    name='params_file',
    default_value=nav2_params_path,
    description='/home/don/cafe/src/two_wheeled_robot/params')
    
  declare_rviz_config_file_cmd = DeclareLaunchArgument(
    name='rviz_config_file',
    default_value=default_rviz_config_path,
    description='/home/don/cafe/src/two_wheeled_robot/rviz')

  declare_sdf_model_path_cmd = DeclareLaunchArgument(
    name='sdf_model', 
    default_value=sdf_model_path, 
    description='/home/don/cafe/src/two_wheeled_robot/models')
  ...
  declare_urdf_model_path_cmd = DeclareLaunchArgument(
    ...
    description='/home/don/cafe/src/two_wheeled_robot/urdf')
  ...
  declare_world_cmd = DeclareLaunchArgument(
    ...
    description='/home/don/cafe/src/two_wheeled_robot/worlds')
